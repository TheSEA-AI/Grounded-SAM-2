...
def product_outline_extraction_by_mask_multiple_product_types(args, grounding_model, sam2_predictor, intput_dir, output_dir, img_format = 'png', image_resolution = 1024, device='cuda'):
