...
##### for extracting hed images where the inner lines of produts are removed
# usage: 
# python ref_hed_outline_extraction.py --gpu_id 4 --input_dir /home/ec2-user/server/Production/Projects/666666/controlnola/ --output_dir /home/ec2-user/s3data/hed_extract_test --data_hed_dir .
